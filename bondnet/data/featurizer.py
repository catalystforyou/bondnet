...
class BondAsEdgeBidirectedFeaturizer(BondFeaturizer):
    ...
    For example, it can be used together :meth:`bondnet.data.grapher.HomoBidirectedGraph`.
...
class BondAsEdgeCompleteFeaturizer(BondFeaturizer):
    ...
    example, it can be used together :meth:`bondnet.data.grapher.HomoCompleteGraph`.
...
class AtomFeaturizerMechanism(BaseFeaturizer):
    """
    Featurize atoms in a molecule.
